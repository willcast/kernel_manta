...
static struct {
	 ...
	 * PLL M, P, S
	 */
	APLL_FREQ(2100, 0, 3, 7, 7, 7, 2, 5, 0, 7, 7, 505, 6, 0), //87.51 - 83.87
	APLL_FREQ(2000, 0, 3, 7, 7, 7, 2, 5, 0, 7, 7, 490, 6, 0), //83.34 - 81.785
	APLL_FREQ(1900, 0, 3, 7, 7, 7, 2, 5, 0, 7, 7, 475, 6, 0), //79.17
	APLL_FREQ(1800, 0, 3, 7, 7, 7, 2, 5, 0, 7, 7, 450, 6, 0), //75
	APLL_FREQ(1700, 0, 3, 7, 7, 7, 2, 5, 0, 7, 7, 425, 6, 0), //70.83 +4.17+2.085
	APLL_FREQ(1600, 0, 3, 7, 7, 7, 1, 4, 0, 7, 7, 200, 3, 0), //66.67
	APLL_FREQ(1500, 0, 2, 7, 7, 7, 1, 4, 0, 7, 7, 250, 4, 0), //62.5
	APLL_FREQ(1400, 0, 2, 7, 7, 6, 1, 4, 0, 7, 7, 175, 3, 0), //58.33
	...
	APLL_FREQ(700,  0, 1, 7, 7, 3, 1, 1, 0, 7, 7, 175, 3, 1), //58.33
	APLL_FREQ(600,  0, 1, 7, 7, 3, 1, 1, 0, 7, 7, 200, 4, 1), //50
	APLL_FREQ(500,  0, 1, 7, 7, 2, 1, 1, 0, 7, 7, 125, 3, 1), //41.67
	APLL_FREQ(400,  0, 1, 7, 7, 2, 1, 1, 0, 7, 7, 100, 3, 1), //33.33
	APLL_FREQ(300,  0, 1, 7, 7, 1, 1, 1, 0, 7, 7, 200, 4, 2), //25
	APLL_FREQ(200,  0, 1, 7, 7, 1, 1, 1, 0, 7, 7, 100, 3, 2), //16.67
	APLL_FREQ(100,  0, 1, 7, 7, 1, 1, 1, 0, 7, 7, 100, 3, 4), //8.33
};
